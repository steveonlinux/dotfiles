...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "WWW", "DOCS", "GAMES", "COMMS", "MP3", "MP4", "VM", "MISC", "SYS" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "b",     function () awful.spawn("brave")          end,
              {description = "browser", group = "layout"}),          

    awful.key({ modkey,           }, "l",     function () awful.spawn("slock")          end,
              {description = "screen_locker", group = "layout"}),          
  ...
  -- awful.key({ modkey },            "r",     function () awful.spawn("rofi -show run -theme merah") end,
    --          {description = "run prompt", group = "launcher"}),
      --        awful.key({ "Mod1" },            "Tab",     function () awful.spawn("rofi -show window -theme merah") end,
        --      {description = "run running prompt", group = "launcher"}),
